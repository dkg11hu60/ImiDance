...
def main():
    print("=== TELJES API-ALAPÚ TAKARÍTÁS ÉS AUTH ÚJRAGENERÁLÁS ===")
    
    # 1. Lekérdezzük az összes felhasználót admin joggal, és egyesével töröljük őket
    print("1. Létező Auth felhasználók teljes körű törlése...")
    try:
        # A list_users() iteráció vagy pagináció helyett kiterjesztett lekérdezés
        ...
        if users:
            print(f"   Talált Auth felhasználók száma törléshez: {len(users)}")
            for u in users:
            ...
            print("   Az Auth tábla már üres.")
    except Exception as e:
        print(f"   Hiba a listázás/törlés során: {e}")
